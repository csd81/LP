# Original model (no sets, parameters):
# Product mix problem, with a bakery as a problem instance
...
s.t. Available_Flour:
	300 * x1 + 400 * x2 + 360 * x3 + 550 * x4 + 600 * x5 <= 50000;
s.t. Available_Butter:
	200 * x1 + 150 * x2 + 250 * x3 + 280 * x4 + 300 * x5 <= 30000;
s.t. Available_Sugar:
	100 * x1 +   0 * x2 + 250 * x3 + 280 * x4 + 350 * x5 <= 5000;
s.t. Available_Eggs:
	  3 * x1 +   6 * x2 +   5 * x3 +   6 * x4 +   8 * x5 <= 100;
